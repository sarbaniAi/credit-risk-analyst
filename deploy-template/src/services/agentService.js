...
// ============================================================
// CONFIGURATION: Update this endpoint name to match your agent
// Must match SERVING_ENDPOINT in app.yaml
// After changing, run: npm run build
// ============================================================
const AGENT_ENDPOINT = '/api/serving-endpoints/<CHANGE_ME_ENDPOINT_NAME>/invocations';
