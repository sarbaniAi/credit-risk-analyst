...
============================================================
CONFIGURATION: All config is read from environment variables
Set these in app.yaml - see SETUP_GUIDE.md for details
============================================================
"""
...
if not DATABRICKS_HOST:
    logger.error("❌ DATABRICKS_HOST not set! Configure in app.yaml")
if not SERVING_ENDPOINT:
    logger.error("❌ SERVING_ENDPOINT not set! Configure in app.yaml")
if not LAKEBASE_INSTANCE_NAME:
    logger.error("❌ LAKEBASE_INSTANCE_NAME not set! Configure in app.yaml")

logger.info(f"Starting Memory-enabled Credit Risk App")
logger.info(f"Workspace: {DATABRICKS_HOST}")
